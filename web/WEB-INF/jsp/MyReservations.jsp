...
<html>
    <head>
        ...
        <title><spring:message code="MyReservations.title" /></title>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
    ...
    <body>
        ...
        <div class="header">
            <h1> <spring:message code="MyReservations.tableTitle" /> </h1><br/>
        </div>
        <div class="main">
            ...
            <div class="mail-section" style="width: 40%;padding: 3em 30em 3em 1em; left: 60px;">
                ...
                <table class="rwd-table" style="width: 80%">        
                    <th><spring:message code="affichage.marque" /> </th> <th> <spring:message code="affichage.matricule" /> </th>  <th> <spring:message code="MyReservations.dateDeRemise" /> </th> <th>Image </th>
                        <c:forEach var="liste" items="${liste}" >
                        <tr>

                            <td> ${liste.marque}  </td>  <td> ${liste.matricule} </td> <td>${liste.disponibilite}</td> <br/>
                        ...
                        <spring:url value="/reserve/${liste.matricule}/pdf.htm" var="pdf" />
                        <td> <button class="btn btn-primary"  onclick="location.href = '${pdf}'"><spring:message code="MyReservations.recu" /></button> </td>
                        </tr>
                    </c:forEach>
                </table>
                <div class="clear"> </div>
